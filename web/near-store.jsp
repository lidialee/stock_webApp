...
<div class="container" style="padding-top:30px; padding-bottom:30px;">
    ...
    <div class="col-lg-12">
        <div class="jumbotron" style="padding-top:20px; padding-bottom:3px; background-color:transparent;">
            <div class="form-group">
                ...
                <button class="btn btn-danger btn-rounded" type="button" id="response_btn" style="margin-left:10px; float:right; font-color:yellow;">요청 리스트 </button>
                <button class="btn btn-danger btn-rounded" type="button" id="request_btn" style="margin-left:10px; float:right; font-color:yellow;">재고 공유 요청</button>
            </div>
        </div>
    ...
    <div class="row" style="padding-bottom:30px">
        ...
        <div class="col-sm-2 col-md-2 col-lg-2 col-xs-2" style="border-radius:8%; padding-top:10px">
            ...
            <%
                ArrayList<String> shareStoreList = ownerDAO.getSharedStore(storeName);
                for(int i=0;i<shareStoreList.size();i++){

            %>
            <div class="form-row" style="padding:5px">
                <button class="btn btn-danger btn-rounded" type="button" id="<%=shareStoreList.get(i)%>" ><%=shareStoreList.get(i)%></button>
            </div>
            <%
                }
            %>
